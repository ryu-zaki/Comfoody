    ...
    <div className='flex flex-col gap-8 h-full justify-center items-center'>
           ...
           <div className='w-full input-box-con flex flex-col gap-8 items-center mt-2'>
             <div className='relative border-darkBlue w-10/12 h-12 rounded-xl'>
                <input type='email' required className='absolute bg-transparent z-10 inset-0 w-full h-full px-2'/>
             ...
             <img onClick={showPass} width="23" className='absolute top-3 right-3 z-20 cursor-pointer' src='./assets/Login Section/eye-slash.png' alt=''/>
                <input type='password' required className='absolute bg-transparent z-10 inset-0 w-full h-full px-2'/>
             ...
             <img onClick={showPass} width="23" className='absolute top-3 right-3 z-20 cursor-pointer' alt='' src='./assets/Login Section/eye-slash.png'/> 
                <input type='password' required className='absolute bg-transparent z-10 inset-0 w-full h-full px-2' alt=''/>
           ...
           <button onClick={() => setLogSwitch(false)} className='text-sm uppercase bg-white text-brown p-2 px-8 rounded-md border-solid border-2 border-brown'>Sign in</button>
