...
export default function LoginCard({setLogSwitch, showPass}) {
  ...
  return (
    <div className='flex flex-col gap-8 h-full justify-center items-center'>
           ...
           <button onClick={() => setLogSwitch(true)} className='text-sm uppercase bg-white text-brown text- p-2 px-8 rounded-md "border-solid border-2 border-brown'>Register</button>
           </div>
